...
function Navbar() {
  ...
  return (
    <>
      {/* <Link to="/">
        <h3 className='signOut'>Log ud</h3>
      </Link> */}
    <nav>
      <Link to="/assignments">
        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24" className={` navIcon ${location.pathname === '/assignments' ? 'selectedSvg' : ''}`} fill="none">
          <path
      ...
      <Link to="/homepage">
        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24" className={` navIcon ${location.pathname === '/homepage' ? 'selectedSvg' : ''}`} fill="none">
          <path
      ...
      <Link to="/profile">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="60" viewBox="0 0 24 24" className={` navIcon ${location.pathname === '/profile' ? 'selectedSvg' : ''}`} fill="none">
          <path
