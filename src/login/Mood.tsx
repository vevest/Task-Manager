...
const quotes = [
  ...
  "Tag små skridt i den rigtige retning, og du vil nå langt. – Unkown",
  ...
  "Vær ikke bange for at fejle. Vær bange for at du ikke prøver. – Unkown",
  "Hver dag er en ny chance for at ændre dit liv. – Unkown",
  "Når du føler, at du er på kanten af at give op, er du kun én lille indsats væk fra at komme videre. – Unkown",
  "Kraften til at skabe er i dine hænder. – Unkown",
  "Tingene sker ikke for dig. De sker for, hvad du gør med dem. – Unkown",
  "Livet handler ikke om at vente på stormen, men om at lære at danse i regnen. – Unkown",
