    ...
    <div className="containerHomepage">
      ...
      <div className="selectedCharacter">
        <img 
          ...
          alt={`Billede af valgt karakter: ${character || "Ikon"}`} // Brug alt-tekst med beskrivelse
          aria-labelledby="selectedCharacter" // Tilføjer ARIA-forbedring for tilgængelighed
        />
      </div>
      <div className="gridToFlex-Box2">
        <div className="framedContent">
          <div className="flexSB">
            <h2 id="latest-tasks-title">4 nyeste opgaver</h2>
            <Link to={"/assignments"} aria-label="Se alle opgaver">
              <h2>Se alle</h2>
            </Link>
          </div>
          <ul className="latestAssignments" aria-labelledby="latest-tasks-title">
            {tasks.length === 0 ? (
        ...
        <div className="reverse">
          <div className="framedContent">
            <h2 className="textCenter" id="weekly-points-title">Point i denne uge</h2>
            <p className="textCenter pBig" aria-labelledby="weekly-points-title">
              {weeklyPoints} ⚡️
            </p> {/* Brug de ugentlige points fra konteksten */}
          </div>
